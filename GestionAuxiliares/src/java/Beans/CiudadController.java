...
public class CiudadController implements Serializable {
    ...
    private CiudadJpaController jpaController = null;
    ...
    private CiudadJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new CiudadJpaController(Persistence.createEntityManagerFactory("GestionAuxiliaresPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getCiudadCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findCiudadEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getCiudadId());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getCiudadCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findCiudadEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findCiudadEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findCiudadEntities(), true);
    }
    ...
    public static class CiudadControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findCiudad(getKey(value));
        }
