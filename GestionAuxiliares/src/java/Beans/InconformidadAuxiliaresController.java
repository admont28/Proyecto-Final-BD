...
public class InconformidadAuxiliaresController implements Serializable {
    ...
    public String prepareList() {
        recreateModel();
        return "/Pages/inconformidadAuxiliares/List";
    }

    public String prepareView() {
        current = (InconformidadAuxiliares) getItems().getRowData();
        selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "/Pages/inconformidadAuxiliares/View";
    }

    public String prepareCreate() {
        current = new InconformidadAuxiliares();
        selectedItemIndex = -1;
        return "/Pages/inconformidadAuxiliares/Create";
    }
    ...
    public String prepareEdit() {
        current = (InconformidadAuxiliares) getItems().getRowData();
        selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "/Pages/inconformidadAuxiliares/Edit";
    }
