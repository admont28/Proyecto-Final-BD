...
public class DireccionController implements Serializable {
    ...
    private DireccionJpaController jpaController = null;
    ...
    private DireccionJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new DireccionJpaController(Persistence.createEntityManagerFactory("GestionAuxiliaresPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getDireccionCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findDireccionEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getDireccionId());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getDireccionCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findDireccionEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findDireccionEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findDireccionEntities(), true);
    }
    ...
    public static class DireccionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findDireccion(getKey(value));
        }
