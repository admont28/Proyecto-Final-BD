...
public class AreaController implements Serializable {
    ...
    private AreaJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new AreaJpaController(Persistence.createEntityManagerFactory("GestionAuxiliaresPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getAreaCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findAreaEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getAreaId());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getAreaCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findAreaEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findAreaEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findAreaEntities(), true);
    }
    ...
    public static class AreaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findArea(getKey(value));
        }
