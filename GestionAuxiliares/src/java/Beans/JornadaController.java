...
import Controller.JornadaJpaController;
...
public class JornadaController implements Serializable {
    ...
    private JornadaJpaController jpaController = null;
    ...
    private JornadaJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new JornadaJpaController(Persistence.createEntityManagerFactory("GestionAuxiliaresPU"));
        }
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getJornadaId());
    ...
    public static class JornadaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Jornada) {
                ...
                return getStringKey(o.getJornadaId());
            } else {
